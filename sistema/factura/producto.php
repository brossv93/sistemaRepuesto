	...
	<table id="factura_cliente">
		<tr>
			<td class="info_cliente">
				<div class="round">
					<span class="h3">Accesorio</span>
					<table class="datos_cliente">
						<tr>
							<td><label><span class="h4"><b>Accesorio:</b></span></label> <p><?php echo $factura['accesorio_descripcion'];  ?></p></td>
              <td><label><span class="h4"><b>Lote:</b></span></label> <p><?php echo $factura['lote_descripcion'];  ?></p></td>
            </tr>
            <tr>
              <td><label><span class="h4"><b>Marca:</b></span></label> <p><?php echo $factura['marca_descripcion'];  ?></p></td>
            ...
            <tr>
              ...
              <td><label><span class="h4"><b>Color:</b></span></label> <p><?php echo $factura['accesorio_color'];  ?></p></td>
            </tr>
            <tr>
