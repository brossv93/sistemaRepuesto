     ...
     ?>
		...
		<table>
			...
			////paginador
				...
				$sql_register = mysqli_query($conection,"SELECT count(*) as total_registro,p.nombre_persona,p.apellido_persona,t.descripcion_empleado,e.usuario_empleado
																								 from empleado e
																								 ...
																								 WHERE
																								 (e.cod_empleado LIKE '%$busqueda%' OR
																									 p.nombre_persona LIKE '%$busqueda%' OR
																									 p.apellido_persona LIKE '%$busqueda%' OR
																									 t.descripcion_empleado LIKE '%$busqueda%' OR
																									 e.usuario_empleado LIKE '%$busqueda%')");
