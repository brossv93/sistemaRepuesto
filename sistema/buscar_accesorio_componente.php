...
<?php include "includes/scripts.php";?>
	...
	<title>Lista de accesorio componete</title>
</head>
<body>
...
<?php include "includes/header.php"; ?>
    ...
    <?php
     ...
     ?>
		...
		<a href="registro_accesorio_componente.php" class="btn_new"><i class="fas fa-user-plus"></i> Crear componente</a>
		...
		<table>
			...
			////paginador
				...
				$sql_register = mysqli_query($conection,"SELECT count(*) as total_registro
																								 from accesorio_componente c, componente m
																								 WHERE
																								 (accesorio_componente_id LIKE '%$busqueda%' OR
																									accesorio_componente_descripcion LIKE '%$busqueda%' OR
																							  	m.componente_descripcion LIKE '%$busqueda%') AND
																									c.componente_id = m.componente_id");
				...
				$total_paginas = ceil($total_registro / $por_pagina);
					...
					$query = mysqli_query($conection, "SELECT * FROM accesorio_componente a
																										INNER JOIN componente c ON a.componente_id = c.componente_id
																										WHERE
  																								 (accesorio_componente_id LIKE '%$busqueda%' OR
																										accesorio_componente_descripcion LIKE '%$busqueda%' OR
																								  	c.componente_descripcion LIKE '%$busqueda%')
      ...
      ?>
			...
			<tr>
				...
				<td><?php echo $data['componente_descripcion']; ?></td>
				<td>
