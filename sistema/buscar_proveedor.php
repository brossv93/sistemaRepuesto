...
<?php include "includes/header.php"; ?>
    ...
    <?php
     ...
     ?>
		<h1><i class="fas fa-clipboard-list"></i> Lista de Proveedor</h1>
        ...
        <th>Direccion</th>
			...
			////paginador
				...
				$sql_register = mysqli_query($conection,"SELECT count(*) as total_registro
																								 from proveedor
																								 WHERE
																								 (cod_proveedor LIKE '%$busqueda%' OR
																									nombre_proveedor LIKE '%$busqueda%' OR
																									contacto_proveedor LIKE '%$busqueda%' OR
      ...
      ?>
        ...
        <td>
					<a class="link_edit" href="editar_proveedor.php?id=<?php echo $data[0]; ?>"><i class="fas fa-edit"></i> Editar</a>
					|
					<a class="link_delete" href="eliminar_confirmar_proveedor.php?id=<?php echo $data[0]; ?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
				</td>
