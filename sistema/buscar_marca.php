...
<?php include "includes/header.php"; ?>
    ...
    <?php
     ...
     ?>
		<h1><i class="fas fa-clipboard-list"></i> Lista de marcas</h1>
		<a href="registro_marca.php" class="btn_new"><i class="fas fa-user-plus"></i> Crear marca</a>
		...
		<table>
			...
			////paginador
				...
				$sql_register = mysqli_query($conection,"SELECT count(*) as total_registro
																								 from marca
																								 WHERE
																								 (marca_id LIKE '%$busqueda%' OR
																									marca_descripcion LIKE '%$busqueda%')");
      ...
      ?>
			...
			<tr>
				...
				<td>
					<a class="link_edit" href="editar_marca.php?id=<?php echo $data[0]; ?>"><i class="fas fa-edit"></i> Editar</a>
					|
					<a class="link_delete" href="eliminar_confirmar_marca.php?id=<?php echo $data[0]; ?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
				</td>
