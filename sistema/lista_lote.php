		...
		<table>
			...
			////paginador
				...
				$total_paginas = ceil($total_registro / $por_pagina);
					...
					$query = mysqli_query($conection, "SELECT lote_id,lote_descripcion,lote_numero,m.tipoLote_id,m.tipoLote_descripcion
																						 from tipoLote m, lote mo
																						 where m.tipoLote_id = mo.tipoLote_id
