<?php
	...
	if(empty($_REQUEST['f']))
	{
		...
		if($result > 0){
			...
			$query_productos = mysqli_query($conection,"SELECT f.cod_factura,f.fecha_factura,f.total_factura,f.cliente_cod_cliente,f.status,f.tipo_factura_cod_tipo_factura,
			...
			ob_start();
		    include(dirname('__FILE__').'/facturaA.php');
		    $html = ob_get_clean();
